...
using StudentsClient.StudentsService;

namespace StudentsClient
{
    public class MainWindowViewModel : Observable
    {
        private readonly IStudentsService client = new StudentsServiceClient();
        ...
        {
            var temp = client.GetAllStudents();
            populateTable(temp);
        }
        ...
        private void InRangeSubmitClick()
        {
            ...
            {
                var studentsArr = client.GetStudentsFilteredByAverageMark(lowerBound, upperBound);
